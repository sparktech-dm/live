...
const TeamHoverGroup = () => {
  ...
  const extraMembers = [
    { img: img3, name: "Vignesh", role: "Developer" },
    { img: img2, name: "Iraiyanbu", role: "Designer" },
    { img: img4, name: "Sanjay", role: "Analyst" },
    { img: img1, name: "Lokesh", role: "Team Lead" },
  ].slice(0, 4);
      ...
      >
        <AnimatePresence>
          {!hovered && (
            ...
            >
              {/* main (center) card before hovering */}
              <TeamCard {...mainMember} />
            </motion.div>
          )}
        </AnimatePresence>

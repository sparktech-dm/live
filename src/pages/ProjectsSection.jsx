        ...
        <div className="relative w-[90vw] sm:w-[340px] md:w-[400px] h-[500px] sm:h-[540px]">
          {projects.map((project, index) => {
            ...
            return (
              <div
                key={index}
                className="absolute w-full h-full bg-[#2B2B2B]  rounded-3xl shadow-2xl p-5 flex flex-col justify-between rotate-3  ease-out hover:scale-[1.07] transition duration-300 hover:bg-[#1A1A1A] hover:shadow-[0_4px_10px_orange]"
                style={{
